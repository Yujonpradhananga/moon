...
hl.curve("overshot", { type = "bezier", points = { { 0.13, 0.69 }, { 0.29, 1.08 } } })
hl.curve("liner", { type = "bezier", points = { { 1, 1 }, { 1, 1 } } })

hl.config({ animations = { enabled = true } })

hl.animation({ leaf = "windows", enabled = true, speed = 5, bezier = "wind", style = "popin" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 5, bezier = "overshot", style = "popin" })
