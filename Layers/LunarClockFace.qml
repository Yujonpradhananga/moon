  ...
  Rectangle {
    ...
    Rectangle {
      ...
      transform: Rotation {
        ...
        angle: 360/29.53059*Dat.Time.synodicDays
      }
      Shape {
        id: clockHand
    ...
    Rectangle {
      ...
      width: height
      radius: height/2
      color: Dat.Colors.primaryBright
    }
  }
}
